...
class OHQueue(models.Model):
    ...
    # scheduling
    monday_times = models.CharField(max_length=50, default="", blank=True)
    tuesday_times = models.CharField(max_length=50, default="", blank=True)
    wednesday_times = models.CharField(max_length=50, default="", blank=True)
    thursday_times = models.CharField(max_length=50, default="", blank=True)
    friday_times = models.CharField(max_length=50, default="", blank=True)
    saturday_times = models.CharField(max_length=50, default="", blank=True)
    sunday_times = models.CharField(max_length=50, default="", blank=True)
